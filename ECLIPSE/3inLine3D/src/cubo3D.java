...
//_____________________________________________________________________________________________
		...
		//montaCubo
		/*Proposito: Rellena el cubo de espacios vacios
		 * Prototipo: void montaCubo()
...
//_____________________________________________________________________________________________
		...
		//pintaCubo		
		/*Proposito: Pinta el cubo
		* Prototipo: void pintaCubo()
		* Precondiciones: no hay
		* Entradas: no hay
		* E/S: no hay
		* Salidas: no hay, solo pinta en pantalla
		* Postcondiciones: Se ha pintado el cubo en pantalla
		*/		
